!> Expected-fail: rNN_Node (chebyshev metric) with a node from a different Tree must error stop.
...
program Testv020_SINGLE_NODE_QUERY_RNN_NODE_CHEBYSHEV_NON_MEMBER
    ...
    call singleNodeQuery_rNN_Node_Chebyshev_NonMember()
    contains

        subroutine singleNodeQuery_rNN_Node_Chebyshev_NonMember()
            type(KdTree)                 :: t1, t2
...
end program Testv020_SINGLE_NODE_QUERY_RNN_NODE_CHEBYSHEV_NON_MEMBER
