program Testv071_MULTITHREAD_DBSCAN_CONCURRENT
    use NdTreeFortran
    ...
    contains
        ...
        subroutine multithreadDbscanConcurrent()
            ...
            if (errors .ne. 0) then
                write(*, '(A,I0)') '--- Testv071_MULTITHREAD_DBSCAN_CONCURRENT: errors = ', errors
                stop 1
            end if
        end subroutine multithreadDbscanConcurrent
end program Testv071_MULTITHREAD_DBSCAN_CONCURRENT
