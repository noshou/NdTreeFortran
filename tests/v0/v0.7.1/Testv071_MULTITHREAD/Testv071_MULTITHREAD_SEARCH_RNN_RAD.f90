program Testv071_MULTITHREAD_SEARCH_RNN_RAD
    use NdTreeFortran
    ...
    contains
        ...
        subroutine multithreadRnnRad()
            ...
            if (errors .ne. 0) then
                write(*, '(A,I0)') '--- Testv071_MULTITHREAD_SEARCH_RNN_RAD: errors = ', errors
                stop 1
            end if
        end subroutine multithreadRnnRad
end program Testv071_MULTITHREAD_SEARCH_RNN_RAD
