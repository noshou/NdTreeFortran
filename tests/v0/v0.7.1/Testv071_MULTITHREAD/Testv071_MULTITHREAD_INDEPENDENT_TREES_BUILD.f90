program Testv071_MULTITHREAD_INDEPENDENT_TREES_BUILD
    use NdTreeFortran
    ...
    contains
        ...
        subroutine independentTreesBuild()
            ...
            if (failed) then
                write(*, '(A)') '--- Testv071_MULTITHREAD_INDEPENDENT_TREES_BUILD ---'
...
end program Testv071_MULTITHREAD_INDEPENDENT_TREES_BUILD
