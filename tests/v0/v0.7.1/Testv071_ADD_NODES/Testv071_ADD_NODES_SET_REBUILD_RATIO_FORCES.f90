program Testv071_ADD_NODES_SET_REBUILD_RATIO_FORCES
    use NdTreeFortran
    ...
    contains
        ...
        subroutine setRebuildRatioForcesRebuild()
            ...
            if (ratio .ne. 0.01_real64) then
                write(*, '(A)')      '--- Testv071_ADD_NODES_SET_REBUILD_RATIO_FORCES ---'
...
end program Testv071_ADD_NODES_SET_REBUILD_RATIO_FORCES
