program Testv071_ADD_NODES_MULTI_ADD_POP
    use NdTreeFortran
    ...
    contains
        ...
        subroutine multiAddPop()
            ...
            if (pop .ne. 10_int64) then
                write(*, '(A)')         '--- Testv071_ADD_NODES_MULTI_ADD_POP ---'
                write(*, '(A,I0)')      'expected pop = 10, got: ', pop
                stop 1
            end if
        end subroutine multiAddPop
end program Testv071_ADD_NODES_MULTI_ADD_POP
