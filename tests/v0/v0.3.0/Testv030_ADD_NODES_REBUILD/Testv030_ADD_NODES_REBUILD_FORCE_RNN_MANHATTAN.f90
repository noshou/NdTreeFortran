program Testv030_ADD_NODES_REBUILD_FORCE_RNN_MANHATTAN
    use NdTreeFortran
    ...
    contains
        ...
        subroutine rebuildForceRnnManhattan()
            ...
            if (numMods .ne. 0_int64) then
                write(*, '(A)')    '--- Testv030_ADD_NODES_REBUILD_FORCE_RNN_MANHATTAN ---'
...
end program Testv030_ADD_NODES_REBUILD_FORCE_RNN_MANHATTAN
