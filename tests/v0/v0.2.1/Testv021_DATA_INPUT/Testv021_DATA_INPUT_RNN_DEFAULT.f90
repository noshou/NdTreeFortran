program Testv021_DATA_INPUT_RNN_DEFAULT
    use NdTreeFortran
    use iso_fortran_env, only: real64

    call dataInput_rNN_Default()
    contains 
        
        !> expected to return exactly two nodes with data "4" and "6"
        subroutine dataInput_rNN_Default()
            type(KdTree)                 :: t
        ...
        end subroutine dataInput_rNN_Default

end program Testv021_DATA_INPUT_RNN_DEFAULT